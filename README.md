...
A collection of my operating system course assignments. 2026 年同济大学操作系统课程作业合集.
...
2026 年同济大学操作系统课程作业合集。

> ***Relevant course***
> * Operating System 2026 (2026 年同济大学操作系统)

## 仓库组成

* [File Management](文件管理项目)
文件管理项目：虚拟文件系统管理器

* [Memory Management](内存管理项目)
内存管理项目：动态分区分配方式模拟和请求分页分配方式模拟

* [Process Management](进程管理项目)
进程管理项目：电梯调度
